...
console.log((peterHousePrice < 2500000) ? 'Peter is paying more' : 'peter is paying less');
console.log((juliaHousePrice < 1000000) ? 'Julia is paying more' : 'Julia is paying less');